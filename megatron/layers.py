...
from megatron.initialize import get_model_parallel_rank, get_model_parallel_world_size
from megatron.mapping import (
    copy_to_model_parallel_region,
    gather_from_model_parallel_region,
    reduce_from_model_parallel_region,
    scatter_to_model_parallel_region,
)
from megatron.utils import VocabUtility, divide_and_check_no_remainder
